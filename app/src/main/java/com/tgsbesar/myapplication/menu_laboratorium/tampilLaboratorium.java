...
public class tampilLaboratorium extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listTransaksi = new ArrayList<transaksiLaboratorium>();
        ...
        Button btn_cetak = (Button)findViewById(R.id.buttonSendLab);
        btn_cetak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(tampilLaboratorium.this,"Cetak bukti pendaftaran dapat dilihat pada file Download", Toast.LENGTH_LONG).show();
    ...
    private void createPdf() throws FileNotFoundException, DocumentException{
        ...
        //nama file pdf
        String pdfname = "TransaksiLab"+".pdf";
        ...
        //judul dokumen
        Paragraph judul = new Paragraph(" Data Transaksi Laboratorium \n\n", new
        ...
        com.itextpdf.text.Font f = new
                ...
                com.itextpdf.text.Font.NORMAL, BaseColor.BLACK);
        Paragraph Pembuka = new Paragraph("\nBerikut merupakan data laboratorium yang dipesan : \n\n",f);
        Pembuka.setIndentationLeft(20);
        document.add(Pembuka);

        //table
        PdfPTable tableHeader = new PdfPTable(new float[]{3,3,3,3,3});
        ...
        PdfPCell h1 = new PdfPCell(new Phrase("Paket Check-Up"));
        h1.setHorizontalAlignment(Element.ALIGN_CENTER);
        h1.setPaddingBottom(5);
        PdfPCell h2 = new PdfPCell(new Phrase("Harga Paket"));
        h2.setHorizontalAlignment(Element.ALIGN_CENTER);
        h2.setPaddingBottom(5);
        PdfPCell h4 = new PdfPCell(new Phrase("Tanggal"));
        h4.setHorizontalAlignment(Element.ALIGN_CENTER);
        h4.setPaddingBottom(5);
        PdfPCell h5 = new PdfPCell(new Phrase("Jam"));
        h5.setHorizontalAlignment(Element.ALIGN_CENTER);
        h5.setPaddingBottom(5);
        PdfPCell h6 = new PdfPCell(new Phrase("No Atrian"));
        ...
        //isi tabel
        PdfPTable tableData = new PdfPTable(new float[]{3,3,3,3,3});
        ...
        for(int x=0;x<arrLength;x++){
            for(int i=0;i<cells.length;i++){
                if(i==0){
                    tableData.addCell(listTransaksi.get(x).getPaket_checkUp());
                }else if(i==1){
                    tableData.addCell("Rp " + String.valueOf(listTransaksi.get(x).getHarga_checkUp()));
                }else if(i==2){
                    tableData.addCell(listTransaksi.get(x).getTgl_checkUp());
                }else if(i==3){
                    tableData.addCell(listTransaksi.get(x).getJam_checkUp());
                }else{
                    tableData.addCell(String.valueOf(no_booking));
                }
        ...
        final JsonObjectRequest stringRequest = new JsonObjectRequest(GET, transaksiLaboratoriumAPI.URL_SELECT +"email?email="+email
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    no_booking=id;
                    listTransaksi.clear();
                    listTransaksi.add(transaksiLaboratorium);
